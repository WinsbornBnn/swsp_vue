<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="学校名称">
              <j-input placeholder="请输入学校名称" v-model="queryParam.dwmc"></j-input>
            </a-form-item>
          </a-col>
          <!-- <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" icon="plus" v-has="'sch:add'">新增</a-button>
      <a-button type="primary" icon="download" @click="handleExportXls('省级-生活服务业单位')" v-has="'sch:out'">导出</a-button>
      <a-upload
        name="file"
      ...
      <a-dropdown v-if="selectedRowKeys.length > 0" v-has="'sch:delete'">
        <a-menu slot="overlay">
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)"  v-has="'sch:edit'">编辑</a>

          <a-divider type="vertical" />
          <a-dropdown  v-has="'sch:delete'">
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        list: "/serviceUnit/serviceUnit/listsch",
