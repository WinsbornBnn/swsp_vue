<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="节水技改">
                ...
                >
                  <a-select-option value="1"> 节水技改工业企业</a-select-option>
                  <a-select-option value="2"> 非节水技改工业企业</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
          </template>
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('省级-工业企业')">导出</a-button>
      <a-upload
        name="file"
